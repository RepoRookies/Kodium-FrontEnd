...
const MergeSortGuide: React.FC = () => {
  return (
    <div className="p-6 bg-primary/85 text-white shadow-md">
      ...
      <ol className="list-decimal list-inside mb-4">
        <li>
          If the array has one or zero elements, it is already sorted. Return the array.
        </li>
        <li>
          Split the array into two halves.
        </li>
        <li>
          Call the merge sort function recursively on both halves.
        </li>
        <li>
      ...
      <p className="mb-4">
        ...
        This is because the algorithm splits the array in half (log n) and then merges the elements (n).
      </p>
      ...
      <p className="mb-4">
        ...
        After applying Merge Sort, the steps would look like this:
      </p>
      <ol className="list-decimal list-inside mb-4">
